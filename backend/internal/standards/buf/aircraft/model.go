...
// Descriptor returns the standards-framework descriptor for BUF aircraft.
				...
				Profiles: []framework.Profile{
					{
						...
						ParameterSchema: framework.ParameterSchema{
							Parameters: []framework.ParameterDefinition{
								...
								{Name: "reference_power_level_db", Kind: framework.ParameterKindFloat, DefaultValue: "110", Description: "Reference sound power level for imported aircraft sources"},
								...
								{Name: "track_start_height_m", Kind: framework.ParameterKindFloat, DefaultValue: "20", Min: &minZero, Description: "Start altitude of imported flight tracks"},
								{Name: "track_end_height_m", Kind: framework.ParameterKindFloat, DefaultValue: "250", Min: &minZero, Description: "End altitude of imported flight tracks"},
								...
								{Name: "lateral_directivity_db", Kind: framework.ParameterKindFloat, DefaultValue: "1.0", Description: "Lateral directivity adjustment"},
