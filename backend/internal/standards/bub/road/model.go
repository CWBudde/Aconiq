				...
				Profiles: []framework.Profile{
					{
						...
						ParameterSchema: framework.ParameterSchema{
							Parameters: []framework.ParameterDefinition{
								...
								{Name: "road_speed_kph", Kind: framework.ParameterKindFloat, Unit: framework.UnitKilometersPerHour, DefaultValue: "60", Min: &minPositive, Description: "Default speed for imported road line sources"},
								{Name: "road_gradient_percent", Kind: framework.ParameterKindFloat, Unit: framework.UnitPercent, DefaultValue: "0", Min: &minGradient, Max: &maxGradient, Description: "Default gradient for imported road line sources"},
								...
								{Name: "road_temperature_c", Kind: framework.ParameterKindFloat, Unit: framework.UnitDegreeCelsius, DefaultValue: "15", Description: "Reference temperature used for BUB mapping adjustments"},
