				...
				Profiles: []framework.Profile{
					{
						...
						ParameterSchema: framework.ParameterSchema{
							Parameters: []framework.ParameterDefinition{
								...
								{Name: "minimum_building_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "3", Min: &minBuildingHeight, Description: "Minimum building height fallback when deriving occupancy is needed"},
								{Name: "floor_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "3", Min: &minPositive, Description: "Floor height used to estimate dwelling count from building height"},
								...
								{Name: "threshold_lden_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "55", Description: "Lden threshold for affected dwellings/persons"},
								{Name: "threshold_lnight_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "50", Description: "Lnight threshold for affected dwellings/persons"},
								...
								{Name: "facade_receiver_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "4", Min: &minZero, Description: "Representative receiver height for building exposure evaluation"},
								...
								{Name: "road_speed_kph", Kind: framework.ParameterKindFloat, Unit: framework.UnitKilometersPerHour, DefaultValue: "60", Min: &minPositive, Description: "Default speed for imported BUB road sources"},
								{Name: "road_gradient_percent", Kind: framework.ParameterKindFloat, Unit: framework.UnitPercent, DefaultValue: "0", Description: "Default gradient for imported BUB road sources"},
								...
								{Name: "road_junction_distance_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "0", Min: &minZero, Description: "Distance to the nearest influencing junction for imported BUB road sources"},
								{Name: "road_temperature_c", Kind: framework.ParameterKindFloat, Unit: framework.UnitDegreeCelsius, DefaultValue: "15", Description: "Reference temperature used for imported BUB road sources"},
								...
								{Name: "traffic_day_light_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "900", Min: &minZero, Description: "Day light vehicles per hour"},
								{Name: "traffic_day_medium_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "120", Min: &minZero, Description: "Day medium vehicles per hour"},
								{Name: "traffic_day_heavy_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "90", Min: &minZero, Description: "Day heavy vehicles per hour"},
								{Name: "traffic_day_ptw_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "30", Min: &minZero, Description: "Day powered two-wheelers per hour"},
								{Name: "traffic_evening_light_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "500", Min: &minZero, Description: "Evening light vehicles per hour"},
								{Name: "traffic_evening_medium_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "60", Min: &minZero, Description: "Evening medium vehicles per hour"},
								{Name: "traffic_evening_heavy_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "45", Min: &minZero, Description: "Evening heavy vehicles per hour"},
								{Name: "traffic_evening_ptw_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "15", Min: &minZero, Description: "Evening powered two-wheelers per hour"},
								{Name: "traffic_night_light_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "250", Min: &minZero, Description: "Night light vehicles per hour"},
								{Name: "traffic_night_medium_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "30", Min: &minZero, Description: "Night medium vehicles per hour"},
								{Name: "traffic_night_heavy_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "30", Min: &minZero, Description: "Night heavy vehicles per hour"},
								{Name: "traffic_night_ptw_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "5", Min: &minZero, Description: "Night powered two-wheelers per hour"},
								...
								{Name: "ground_attenuation_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "1.2", Min: &minZero, Description: "Ground attenuation term"},
								{Name: "urban_canyon_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "0", Min: &minZero, Description: "Urban canyon mapping adjustment"},
								{Name: "intersection_density_per_km", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerKilometer, DefaultValue: "0", Min: &minZero, Description: "Intersection density mapping adjustment"},
								...
								{Name: "reference_power_level_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "110", Description: "Reference sound power level for imported BUF aircraft sources"},
								...
								{Name: "bank_angle_deg", Kind: framework.ParameterKindFloat, Unit: framework.UnitDegree, DefaultValue: "0", Description: "Bank angle used for BUF aircraft directivity adjustment"},
								{Name: "lateral_offset_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "0", Description: "Lateral procedure offset for imported BUF aircraft sources"},
								{Name: "track_start_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "20", Min: &minZero, Description: "Start altitude of imported BUF flight tracks"},
								{Name: "track_end_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "250", Min: &minZero, Description: "End altitude of imported BUF flight tracks"},
								...
								{Name: "lateral_directivity_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "1.0", Description: "Lateral directivity adjustment for BUF aircraft"},
								{Name: "approach_correction_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "1.5", Min: &minZero, Description: "Arrival correction term for BUF aircraft"},
								{Name: "climb_correction_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "2.5", Min: &minZero, Description: "Departure climb correction term for BUF aircraft"},
								{Name: "min_slant_distance_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "20", Min: &minPositive, Description: "Minimum slant propagation distance for BUF aircraft"},
							},
						},
					},
				},
