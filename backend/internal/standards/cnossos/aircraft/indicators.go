...
const (
	...
	BuiltinModelVersion = "baseline-preview-aircraft-v2"
...
// ProvenanceMetadata returns CNOSSOS aircraft baseline metadata for run provenance.
func ProvenanceMetadata(params map[string]string) map[string]string {
	metadata := map[string]string{
		...
		"compliance_boundary":    "baseline-preview-expanded-cnossos-aircraft-contract",
