				...
				Profiles: []framework.Profile{
					{
						...
						ParameterSchema: framework.ParameterSchema{
							Parameters: []framework.ParameterDefinition{
								...
								{Name: "reference_power_level_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "108", Description: "Reference sound power level for imported aircraft sources"},
								...
								{Name: "track_start_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "30", Min: &minZero, Description: "Start altitude of imported flight tracks"},
								{Name: "track_end_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "300", Min: &minZero, Description: "End altitude of imported flight tracks"},
								{Name: "movement_day_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "10", Min: &minZero, Description: "Day aircraft movements per hour"},
								{Name: "movement_evening_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "5", Min: &minZero, Description: "Evening aircraft movements per hour"},
								...
								{Name: "lateral_directivity_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "0", Description: "Lateral directivity adjustment"},
