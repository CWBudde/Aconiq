				...
				Profiles: []framework.Profile{
					{
						...
						ParameterSchema: framework.ParameterSchema{
							Parameters: []framework.ParameterDefinition{
								...
								{Name: "grid_padding_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "20", Min: &minZero, Description: "Padding around rail extent in meters"},
								...
								{Name: "rail_average_train_speed_kph", Kind: framework.ParameterKindFloat, Unit: framework.UnitKilometersPerHour, DefaultValue: "90", Min: &minPositive, Description: "Default train speed for imported rail sources"},
								...
								{Name: "rail_curve_radius_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "500", Min: &minZero, Description: "Default curve radius for imported rail sources"},
								...
								{Name: "traffic_day_trains_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "12", Min: &minZero, Description: "Day trains per hour"},
								{Name: "traffic_evening_trains_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "6", Min: &minZero, Description: "Evening trains per hour"},
								{Name: "traffic_night_trains_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "4", Min: &minZero, Description: "Night trains per hour"},
								...
								{Name: "bridge_correction_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "2", Min: &minZero, Description: "Bridge correction term"},
								{Name: "curve_squeal_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "5", Min: &minZero, Description: "Curve squeal correction term"},
