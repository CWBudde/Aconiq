...
func Descriptor() framework.StandardDescriptor {
	...
	return framework.StandardDescriptor{
		...
		ID:             StandardID,
		Description:    "Scaffold road module: a typed source schema and deterministic indicators only, with no CNOSSOS-EU coefficients, no directive spectra and no octave bands; the intended target is Directive 2015/996 Annex II road, which it does not implement.",
				...
				Profiles: []framework.Profile{
					{
						...
						ParameterSchema: framework.ParameterSchema{
							Parameters: []framework.ParameterDefinition{
								...
								{Name: "road_speed_kph", Kind: framework.ParameterKindFloat, Unit: framework.UnitKilometersPerHour, DefaultValue: "70", Min: &minPositive, Description: "Default speed for imported line sources"},
								{Name: "road_gradient_percent", Kind: framework.ParameterKindFloat, Unit: framework.UnitPercent, DefaultValue: "0", Min: &minGradient, Max: &maxGradient, Description: "Default gradient for imported line sources"},
								{
								...
								{Name: "road_junction_distance_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "0", Min: &minZero, Description: "Distance to the nearest influencing junction"},
								{Name: "road_temperature_c", Kind: framework.ParameterKindFloat, Unit: framework.UnitDegreeCelsius, DefaultValue: "20", Description: "Reference air temperature used for road emission context"},
								...
								{Name: "traffic_day_ptw_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "40", Min: &minZero, Description: "Day powered two-wheelers per hour"},
								{Name: "traffic_evening_ptw_vph", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "20", Min: &minZero, Description: "Evening powered two-wheelers per hour"},
								...
								{Name: "ground_attenuation_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "1.5", Min: &minZero, Description: "Ground attenuation term"},
								{Name: "barrier_attenuation_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "0", Min: &minZero, Description: "Barrier attenuation term"},
