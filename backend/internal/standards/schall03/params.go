...
func params() []param {
	...
	return []param{
		{definition: framework.ParameterDefinition{Name: "grid_resolution_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "10", Min: &minPositive, Description: "Receiver grid spacing in meters for the future Schall 03 run/export path"}},
		{definition: framework.ParameterDefinition{Name: "grid_padding_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "30", Min: &minZero, Description: "Padding around source extent in meters"}},
		{definition: framework.ParameterDefinition{Name: "receiver_height_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "4", Min: &minZero, Description: "Receiver height in meters"}, provenance: true},
		...
		{definition: framework.ParameterDefinition{Name: "rail_average_train_speed_kph", Kind: framework.ParameterKindFloat, Unit: framework.UnitKilometersPerHour, DefaultValue: "100", Min: &minPositive, Description: "Default train speed for imported rail sources"}, provenance: true},
		{definition: framework.ParameterDefinition{Name: "rail_curve_radius_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "500", Min: &minZero, Description: "Default curve radius for imported rail sources"}},
		...
		{definition: framework.ParameterDefinition{Name: "traffic_day_trains_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "8", Min: &minZero, Description: "Default day trains per hour for imported rail sources"}, provenance: true},
		{definition: framework.ParameterDefinition{Name: "traffic_night_trains_per_hour", Kind: framework.ParameterKindFloat, Unit: framework.UnitPerHour, DefaultValue: "4", Min: &minZero, Description: "Default night trains per hour for imported rail sources"}, provenance: true},
		{
			definition:  framework.ParameterDefinition{Name: "air_absorption_db_per_km", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibelPerKilometer, DefaultValue: "0.7", Min: &minZero, Description: "Baseline air absorption term"},
			provenance:  true,
			configValue: func(cfg PropagationConfig) float64 { return cfg.AirAbsorptionDBPerKM },
			configMin:   0,
		},
		{
			definition:  framework.ParameterDefinition{Name: "ground_attenuation_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "1.2", Min: &minZero, Description: "Baseline ground attenuation term"},
			provenance:  true,
			configValue: func(cfg PropagationConfig) float64 { return cfg.GroundAttenuationDB },
			configMin:   0,
		},
		{
			definition:  framework.ParameterDefinition{Name: "slab_track_correction_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "1.5", Min: &minZero, Description: "Additional correction for slab track sections"},
			provenance:  true,
			configValue: func(cfg PropagationConfig) float64 { return cfg.SlabTrackCorrectionDB },
			configMin:   0,
		},
		{
			definition:  framework.ParameterDefinition{Name: "bridge_correction_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "2", Min: &minZero, Description: "Additional correction for bridge sections"},
			provenance:  true,
			configValue: func(cfg PropagationConfig) float64 { return cfg.BridgeCorrectionDB },
			configMin:   0,
		},
		{
			definition:  framework.ParameterDefinition{Name: "curve_correction_db", Kind: framework.ParameterKindFloat, Unit: framework.UnitDecibel, DefaultValue: "4", Min: &minZero, Description: "Maximum correction for tight-curve sections"},
			provenance:  true,
			configValue: func(cfg PropagationConfig) float64 { return cfg.CurveCorrectionDB },
			configMin:   0,
		},
		{
			definition:  framework.ParameterDefinition{Name: "min_distance_m", Kind: framework.ParameterKindFloat, Unit: framework.UnitMeter, DefaultValue: "3", Min: &minPositive, Description: "Minimum source-receiver distance for the future propagation chain"},
			provenance:  true,
