...
// Evidence classes and provenance strings shared by the curated fixtures. They
// are reported verbatim in the acceptance evidence record, so every fixture that
// belongs to the same class must spell it identically.
const (
	evidenceClassSynthetic = "license-safe synthetic acceptance fixture"
	evidenceClassDerived   = "license-safe derived acceptance fixture"

	provenanceSynthetic = "repo-authored synthetic scenario"
	provenanceDerived   = "repo-authored derived scenario aligned to Phase 17 QA runner coverage"
)
	...
	return []Fixture{
		{
			...
			EvidenceClass:    evidenceClassDerived,
